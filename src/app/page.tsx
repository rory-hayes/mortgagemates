...
const process = [
  ...
  { icon: SparklesIcon, title: "We review one fit", copy: "An admin reviews hard rules and the practical questions that need discussion." },
