...
type DashboardProps = {
  ...
  match: { id: string; status: string; compatibility: Record<string, unknown>; user_a: string; user_b: string; expires_at: string } | null;
...
export function MemberDashboard({ profile, documentStats, match, decision: initialDecision, gates, contact }: DashboardProps) {
